...
#        print(d2)
 ...
 #       print(d3)
        d4 = OrderedDict([('layers.1.graph_conv.lin.weight', v) if k == 'layers.1.graph_conv.weight' else (k, v) for k, v in d3.items()])
        #print(d4)
        d5 = OrderedDict([('layers.1.graph_conv.lin.bias', v) if k == 'layers.1.graph_conv.bias' else (k, v) for k, v in d4.items()])
  #      print(d5)
        d6 = OrderedDict([('pool1.graph_pool.gnn.lin_rel.weight', v) if k == 'pool1.graph_pool.gnn.lin_l.weight' else (k, v) for k, v in d5.items()])
   #     print(d6)
